...
def train_experiment(
    ...
    parameters: dict[str, Any] = {
        ...
        "hsv_h": 0.0,
        "hsv_s": 0.0,
        "hsv_v": 0.10 if augmented else 0.0,
        "degrees": 7.0 if augmented else 0.0,
        "translate": 0.02 if augmented else 0.0,
        "scale": 0.05 if augmented else 0.0,
        "shear": 0.0,
        "perspective": 0.0,
        "flipud": 0.0,
        "fliplr": 0.0,
    ...
    return {
        ...
        "batch": batch,
        "device": device,
        "augmentation": "medical_mild" if augmented else "minimal",
